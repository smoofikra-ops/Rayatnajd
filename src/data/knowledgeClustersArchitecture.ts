...
export const comprehensiveClusters: ClusterPage[] = [
  {
    ...
    heroImage: "https://res.cloudinary.com/erfajaoa/image/upload/f_auto,q_auto/v1/clusters/landscaping",
    subcategories: ["residential-landscaping", "commercial-landscaping", "public-parks"],
    articleSlots: ["landscaping-basics", "plant-selection-guide", "soil-preparation"],
  ...
  },
  {
    ...
    articleSlots: ["palm-disease-prevention", "palm-planting-guide", "best-palms-for-riyadh"],
  ...
  },
  {
    ...
    heroImage: "https://res.cloudinary.com/erfajaoa/image/upload/f_auto,q_auto/v1/clusters/trees",
    subcategories: ["shade-trees", "fruit-trees", "drought-resistant-trees"],
    articleSlots: ["native-saudi-trees", "fast-growing-trees", "tree-pruning-guide"],
  ...
  },
  {
    ...
    heroImage: "https://res.cloudinary.com/erfajaoa/image/upload/f_auto,q_auto/v1/clusters/nurseries",
    subcategories: ["wholesale-nurseries", "plant-production", "greenhouses"],
    articleSlots: ["nursery-management-best-practices", "seed-germination", "plant-propagation"],
  ...
  },
  {
    ...
    heroImage: "https://res.cloudinary.com/erfajaoa/image/upload/f_auto,q_auto/v1/clusters/irrigation",
    subcategories: ["drip-irrigation", "smart-irrigation", "sprinkler-systems"],
    articleSlots: ["water-conservation-irrigation", "smart-controllers-setup", "drip-vs-sprinkler"],
  ...
  },
  {
    ...
    heroImage: "https://res.cloudinary.com/erfajaoa/image/upload/f_auto,q_auto/v1/clusters/maintenance",
    subcategories: ["pruning", "fertilization", "pest-control"],
    articleSlots: ["seasonal-maintenance-calendar", "organic-fertilizers-guide", "identifying-plant-pests"],
  ...
  },
  {
    ...
    heroImage: "https://res.cloudinary.com/erfajaoa/image/upload/f_auto,q_auto/v1/clusters/sustainability",
    subcategories: ["carbon-reduction", "water-management", "biodiversity"],
    articleSlots: ["trees-and-carbon-capture", "sustainable-landscaping-materials", "combating-desertification"],
  ...
  },
  {
    ...
    heroImage: "https://res.cloudinary.com/erfajaoa/image/upload/f_auto,q_auto/v1/clusters/urban",
    subcategories: ["streetscapes", "public-plazas", "urban-parks"],
    articleSlots: ["designing-walkable-cities", "street-tree-selection", "urban-heat-island-effect"],
    relatedServicesIds: ["landscape-design", "execution"],
  ...
  },
  {
    ...
    heroImage: "https://res.cloudinary.com/erfajaoa/image/upload/f_auto,q_auto/v1/clusters/gov-projects",
    subcategories: ["ministry-guidelines", "municipality-projects", "mega-projects"],
    articleSlots: ["momra-guidelines", "bidding-for-green-projects", "quality-control-in-public-parks"],
  ...
  },
  {
    ...
    heroImage: "https://res.cloudinary.com/erfajaoa/image/upload/f_auto,q_auto/v1/clusters/vision-2030",
    subcategories: ["green-riyadh-initiative", "saudi-green-initiative", "quality-of-life-program"],
    articleSlots: ["vision-2030-environmental-goals", "impact-of-green-riyadh", "10-billion-trees-initiative"],
