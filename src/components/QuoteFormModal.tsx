              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input required type="tel" dir="ltr" placeholder="0557555716" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} className="w-full bg-bg-secondary border border-text-main/10 rounded-xl px-4 py-3 focus:outline-none focus:border-primary text-left" />
                  </div>
                  <div>
